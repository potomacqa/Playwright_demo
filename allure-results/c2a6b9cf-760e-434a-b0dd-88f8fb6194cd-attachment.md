...
- generic [ref=e1]:
  - generic [ref=e4]:
    ...
    - generic [ref=e7]:
      ...
      - link "testData.txt" [ref=e30] [cursor=pointer]:
        - /url: download/testData.txt
      - link "zero_bytes_file.txt" [ref=e31] [cursor=pointer]:
        - /url: download/zero_bytes_file.txt
      - link "RoboWaves Timesheet.xlsx" [ref=e32] [cursor=pointer]:
        - /url: download/RoboWaves Timesheet.xlsx
      - link "tmp0p85eu_3.txt" [ref=e33] [cursor=pointer]:
        - /url: download/tmp0p85eu_3.txt
      - link "selenium-snapshot.png" [ref=e34] [cursor=pointer]:
        - /url: download/selenium-snapshot.png
      - link "Cucumber_Tutorial_for_Interview.pdf" [ref=e35] [cursor=pointer]:
        - /url: download/Cucumber_Tutorial_for_Interview.pdf
      - link "tmpgjruan8g.txt" [ref=e36] [cursor=pointer]:
        - /url: download/tmpgjruan8g.txt
      - link "TestDocument.pdf" [ref=e37] [cursor=pointer]:
        - /url: download/TestDocument.pdf
      - link "test-image.png" [ref=e38] [cursor=pointer]:
        - /url: download/test-image.png
      - link "tmpuaxp4u69.txt" [ref=e39] [cursor=pointer]:
        - /url: download/tmpuaxp4u69.txt
      - link "1D10AA4E-497C-4118-A738-91353556C340.png" [ref=e40] [cursor=pointer]:
        - /url: download/1D10AA4E-497C-4118-A738-91353556C340.png
      - link "responseBodyMockExample.json" [ref=e41] [cursor=pointer]:
        - /url: download/responseBodyMockExample.json
      - link "LambdaTest.txt" [ref=e42] [cursor=pointer]:
        - /url: download/LambdaTest.txt
      - link "CypressCourse.pdf" [ref=e43] [cursor=pointer]:
        - /url: download/CypressCourse.pdf
      - link "File DOC.doc" [ref=e44] [cursor=pointer]:
        - /url: download/File DOC.doc
      - link "puppy.png" [ref=e45] [cursor=pointer]:
        - /url: download/puppy.png
      - link "upload-me.txt" [ref=e46] [cursor=pointer]:
        - /url: download/upload-me.txt
      - link "20MB.bin" [ref=e47] [cursor=pointer]:
        - /url: download/20MB.bin
      - link "selenide-intro.txt" [ref=e48] [cursor=pointer]:
        - /url: download/selenide-intro.txt
      - link "Cypress_Full_Course.pdf" [ref=e49] [cursor=pointer]:
        - /url: download/Cypress_Full_Course.pdf
      - link "foto2.png" [ref=e50] [cursor=pointer]:
        - /url: download/foto2.png
      - link "Excel.xlsx" [ref=e51] [cursor=pointer]:
        - /url: download/Excel.xlsx
      - link "arquivo.txt" [ref=e52] [cursor=pointer]:
        - /url: download/arquivo.txt
      - link "file.json" [ref=e53] [cursor=pointer]:
        - /url: download/file.json
      - link "spectrum-logo.png" [ref=e54] [cursor=pointer]:
        - /url: download/spectrum-logo.png
      - link "tmpip0lrza5.txt" [ref=e55] [cursor=pointer]:
        - /url: download/tmpip0lrza5.txt
      - link "Invoice (18).PDF" [ref=e56] [cursor=pointer]:
        - /url: download/Invoice (18).PDF
      - link "test-file.txt" [ref=e57] [cursor=pointer]:
        - /url: download/test-file.txt
      - link "tmpkrz5ljvj.txt" [ref=e58] [cursor=pointer]:
        - /url: download/tmpkrz5ljvj.txt
      - link "foto.png" [ref=e59] [cursor=pointer]:
        - /url: download/foto.png
      - link "TestData.xlsx" [ref=e60] [cursor=pointer]:
        - /url: download/TestData.xlsx
      - link "sample_media_file.png" [ref=e61] [cursor=pointer]:
        - /url: download/sample_media_file.png
      - link "large-test-file.txt" [ref=e62] [cursor=pointer]:
        - /url: download/large-test-file.txt
      - link "sample3.pdf" [ref=e63] [cursor=pointer]:
        - /url: download/sample3.pdf
      - link "file.txt" [ref=e64] [cursor=pointer]:
        - /url: download/file.txt
      - link "some-file.txt" [ref=e65] [cursor=pointer]:
        - /url: download/some-file.txt
      - link "iukklum069_Screenshot (2).png" [ref=e66] [cursor=pointer]:
        - /url: download/iukklum069_Screenshot (2).png
      - link "Jpeg_with_exif.jpeg" [ref=e67] [cursor=pointer]:
        - /url: download/Jpeg_with_exif.jpeg
      - link "sample-zip-file.zip" [ref=e68] [cursor=pointer]:
        - /url: download/sample-zip-file.zip
      - link "TextDoc.txt" [ref=e69] [cursor=pointer]:
        - /url: download/TextDoc.txt
      - link "test-upload.txt" [ref=e70] [cursor=pointer]:
